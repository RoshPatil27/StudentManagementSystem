...
export const AddSubjectWrapper = styled.div`
    min-height: 100vh;
    display: flex;
...
export const AddSubjectTitle = styled.h2`
    text-align: center;
    margin-bottom: 25px;
    color: #2c3e50;
    font-weight: 600;
...
export const AddSubjectField = styled.div`
    display: flex;
    flex-direction: column;
    margin-bottom: 16px;
`;

export const AddSubjectLabel = styled.label`
  font-size: 14px;
  font-weight: 500;
  margin-bottom: 6px;
  color: #34495e;
